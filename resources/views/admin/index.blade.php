        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 mb-4">
              ...
              <form action="/admin/dashboard/cari" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-6"><h1 class="h3 mb-0 text-gray-800">Data Pengguna</h1></div>
                    <div class="col-sm-6 d-inline">
                        <input name="key" type="text" class="form-control" placeholder="Cari perusahaan">
